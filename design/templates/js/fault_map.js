...
__init__ : function(map_dom_id, list_dom_id, center, sections) {
    ...
    for (var sid in this.sections) {
        if (this.sections.hasOwnProperty(sid)) {
            ...
            google.maps.event.addListener(sections[sid].unselected_polyLine, 'click', this.sectionClick);
            google.maps.event.addListener(sections[sid].unselected_polyLine, 'mouseover', this.sectionHover);
            google.maps.event.addListener(sections[sid].unselected_polyLine, 'mouseout', this.sectionUnHover);
            ...
            google.maps.event.addListener(sections[sid].selected_polyLine, 'click', this.sectionClick);
            google.maps.event.addListener(sections[sid].selected_polyLine, 'mouseover', this.sectionHover);
            google.maps.event.addListener(sections[sid].selected_polyLine, 'mouseout', this.sectionUnHover);
...
searchFieldChange : function(event) {
    // the FaultMap object
    $this = event.data.$this
    
    curr_search_val = new RegExp( $this.search_field.val(), "i" )
